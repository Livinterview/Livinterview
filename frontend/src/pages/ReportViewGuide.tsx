  ...
  return (
    <div className="flex flex-col items-start w-[794px] mt-12">
      ...
      >
        ...
        >
          {/* 안녕하세요, 삶권분석 리포트를 제작하고 있는 삶터뷰입니다.
            삶권분석 서비스를 신청해주셔서 감사드리며, 보내드리는 삶권분석 리포트 읽으실 때 도움이 되실 수
            있도록 안내를 몇 가지 드리려고 합니다. 삶권분석 리포트를 읽으시기 전에 참고 부탁드립니다. */}
        </div>
        ...
        >
          보내드리는 삶권분석 리포트는 처음 작성해주신 삶권분석 설문과 2025년 5월 기준 최근 1년 간의 데이터를 기반으로 제작하였습니다.
        </div>
        ...
        >
          작성해주신 삶권분석 설문 답변과 삶터뷰에서 개발한 8개 지표를 기준으로 맞춤형 오피스텔을 추천해드립니다. 8개 지표는 교통, 편의, 안전, 건강, 녹지, 생활, 놀이, 운동으로, 학군 등의 정보보다 1인가구에게 유의미한 항목들로 구성되었으며, 앞으로도 1인가구들이 거주지를 선택할 때 중요하게 생각하는 요소들을 지표로 개발할 예정입니다.
        </div>
